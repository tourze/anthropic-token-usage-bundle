 ...
 * 用户维度Token使用记录管理
 *
 * @extends AbstractCrudController<UserUsage>
 */
#[AdminCrud(
    routePath: '/anthropic-token-usage/user-usage',
    routeName: 'anthropic_token_usage_user_usage'
)]
final class UserUsageCrudController extends AbstractCrudController
{
    ...
    {
        return $crud
            ->setEntityLabelInSingular('用户使用记录')
            ->setEntityLabelInPlural('用户使用记录')
            ->setPageTitle('index', '用户 Token使用记录')
            ->setPageTitle('detail', '用户使用记录详情')
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        yield IntegerField::new('totalTokens', '总Token数')
            ...
            ->setTextAlign('right')
            ->formatValue(static function ($value, UserUsage $entity) {
     ...
     * 批量导出操作
     */
    #[AdminAction(routeName: 'user_usage_export_batch', routePath: '/user-usage/export-batch')]
